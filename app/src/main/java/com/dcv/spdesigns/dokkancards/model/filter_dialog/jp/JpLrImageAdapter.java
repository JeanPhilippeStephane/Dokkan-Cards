...
public class JpLrImageAdapter extends BaseAdapter {

    private Context mContext;

    public JpLrImageAdapter(Context c) {
        mContext = c;
    }

    @Override
    public int getCount() {
        return JPDataHolder.LRCards.size();
    }

    @Override
    public Object getItem(int position) {
        return JPDataHolder.LRCards.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        imageView.setImageResource(JPDataHolder.LRCards.get(position).getCardIcon());
        return imageView;
    }
}
