...
public class SerializeJPData {
    ...
    public static void Write(ArrayList<Integer> icons, ArrayList<Integer> cardArts, ArrayList<String> cardNameAndDescription,
        ...
        editor.putString("IconsJP",iconsJson);
        editor.putString("CardArtJP",cardArtsJson);
        editor.putString("CardNameAndDescJP",cardNameAndDescriptionJson);
        editor.putString("LeaderSkillsJP",leaderSkillsJson);
        editor.putString("SANamesJP",superAttackNamesJson);
        editor.putString("SADescsJP",superAttackDescJson);
        editor.putString("PassiveSkillNamesJP",passiveSkillNamesJson);
        editor.putString("PassiveSkillDescJP",passiveSkillDescJson);
    ...
    public static ArrayList<Integer> ReadIcons(Context context) {
        SharedPreferences appPrefs = PreferenceManager.getDefaultSharedPreferences(context);
        Gson gson = new Gson();
        String iconsJson = appPrefs.getString("IconsJP","");
    ...
    public static ArrayList<Integer> ReadCardArts(Context context) {
        SharedPreferences appPrefs = PreferenceManager.getDefaultSharedPreferences(context);
        Gson gson = new Gson();
        String cardArtsJson = appPrefs.getString("CardArtJP","");
        Type type = new TypeToken<ArrayList<Integer>>(){}.getType();
    ...
    public static ArrayList<String> ReadcardNameAndDescription(Context context) {
        SharedPreferences appPrefs = PreferenceManager.getDefaultSharedPreferences(context);
        Gson gson = new Gson();
        String cardNameAndDescriptionJson = appPrefs.getString("CardNameAndDescJP","");
    ...
    public static ArrayList<String> ReadLeaderSkills(Context context) {
        SharedPreferences appPrefs = PreferenceManager.getDefaultSharedPreferences(context);
        Gson gson = new Gson();
        String leaderSkillsJson = appPrefs.getString("LeaderSkillsJP","");
        Type type = new TypeToken<ArrayList<String>>(){}.getType();
    ...
    public static ArrayList<String> ReadSuperAttacksName(Context context) {
        SharedPreferences appPrefs = PreferenceManager.getDefaultSharedPreferences(context);
        Gson gson = new Gson();
        String superAttacksNameJson = appPrefs.getString("SANamesJP","");
        Type type = new TypeToken<ArrayList<String>>(){}.getType();
    ...
    public static ArrayList<String> ReadSuperAttacksDesc(Context context) {
        SharedPreferences appPrefs = PreferenceManager.getDefaultSharedPreferences(context);
        Gson gson = new Gson();
        String superAttacksDescJson = appPrefs.getString("SADescsJP","");
        Type type = new TypeToken<ArrayList<String>>(){}.getType();
    ...
    public static ArrayList<String> ReadPassiveSkillsName(Context context) {
        SharedPreferences appPrefs = PreferenceManager.getDefaultSharedPreferences(context);
        Gson gson = new Gson();
        String passiveSkillsNameJson = appPrefs.getString("PassiveSkillNamesJP","");
        Type type = new TypeToken<ArrayList<String>>(){}.getType();
